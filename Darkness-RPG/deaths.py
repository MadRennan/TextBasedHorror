...
def him1():
    clear_screen()
    sleep(5)
    typing("Dizem que ele foi invocado por um grupo\n")
    sleep(1.5)
    typing("Já outros.. dizem que foi por uma bruxa..\n")
    clear_screen()
    sleep(1)
    typing("Não se lembram ao certo qual das histórias é a correta mais..\n")
    sleep(1)
    typing("Mas ele fez desse hospicio a sua moradia.\n")
    sleep(2)
    clear_screen()
    sleep(2)
    typing("Em menos de horas, todos morreram\n")
    sleep(3)
    typing("Ele ria..\n")
    clear_screen()
    sleep(1)
